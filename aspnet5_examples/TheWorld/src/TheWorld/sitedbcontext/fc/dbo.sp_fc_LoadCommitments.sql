create procedure [dbo].[sp_fc_LoadCommitments]
...
/* ================================================================================ */
	...
	set @Status				= isnull(@Status,'1;3;4');
...
/* ================================================================================ */			
	if @CutOffStatement is not null	
		exec dbo.sp_pei_irr_GetDTSCutOffDates null,@CutOffStatement,'N';
/* ================================================================================ */
	if @RunType = 1
	begin
...
/* ================================================================================ */
	exec dbo.sp_fc_LoadCommitments_LoadKeys
	...
	@MaxLevel		= @MaxLevel;
/* ================================================================================ */
	exec dbo.sp_fc_LoadCommitments_LoadData
...
GO
grant execute on dbo.sp_fc_LoadCommitments to PE_datawriter, PE_datareader
GO
