create procedure [dbo].[sp_fc_LoadCommitments_LoadData]
@ReportDate			datetime,
...
/* ============================================================================================== */
	...
	begin	
		exec dbo.sp_fc_LoadCommitments_LoadData_PD
...
GO
grant execute on dbo.sp_fc_LoadCommitments_LoadData to PE_datawriter, PE_datareader
GO	