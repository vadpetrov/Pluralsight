create procedure [dbo].[sp_fc_LoadCommitments_SPV_Adapter_Feeders]
@Iteration			int,
@RunType			int		= 1,
...
GO
grant execute on dbo.sp_fc_LoadCommitments_SPV_Adapter_Feeders to PE_datawriter, PE_datareader
GO